...
Define audit scope, objectives, and criteria. Develop audit plan.
**Time**: 1-2h.

### Step 2: Document Review
Review quality manuals, procedures, records. Identify gaps.
**Time**: 2-4h.

### Step 3: On-site Audit
Conduct interviews, observe processes, examine records. Gather evidence.
**Time**: 4-8h.

### Step 4: Findings Analysis
Analyze evidence against criteria. Classify nonconformances.
**Time**: 1-2h.

### Step 5: Reporting
Document findings and recommendations. Prepare audit report.
**Time**: 1-2h.

### Step 6: Corrective Action Planning
Develop corrective action plans. Define timelines and owners.
**Time**: 1-2h.
