...
Define audit scope, objectives, and criteria. Develop audit plan and allocate resources.
**Time**: 1-2h.

### Step 2: Fieldwork Preparation
Gather background information. Prepare audit programs and checklists.
**Time**: 1-2h.

### Step 3: Evidence Gathering
Conduct interviews, review documents, observe processes. Gather sufficient appropriate evidence.
**Time**: 4-8h.

### Step 4: Analysis and Evaluation
Analyze evidence against criteria. Identify findings and root causes.
**Time**: 2-4h.

### Step 5: Reporting
Document findings and recommendations. Prepare draft audit report.
**Time**: 2-4h.

### Step 6: Action Planning
Develop action plans with management. Define remediation timelines and owners.
**Time**: 1-2h.
...
|----------|-------------|-------------|
| [40-risk-assessment](workflows/40-risk-assessment.md) | **Related** | To audit risk management |
