        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a href="#" className="w-9 h-9 bg-gray-800 rounded-full flex items-center justify-center hover:bg-orange-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li><Link to="/category/proteins" className="hover:text-orange-400 transition-colors">Proteins</Link></li>
              <li><Link to="/category/pre-workout" className="hover:text-orange-400 transition-colors">Pre-Workout</Link></li>
              <li><Link to="/category/creatine" className="hover:text-orange-400 transition-colors">Creatine</Link></li>
              <li><Link to="/category/vitamins" className="hover:text-orange-400 transition-colors">Vitamins</Link></li>
            </ul>
          </div>
