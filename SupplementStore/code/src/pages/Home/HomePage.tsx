    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
          ...
          <div>
            <div className="text-3xl font-bold text-orange-600 mb-2">Lab Tested</div>
            <p className="text-gray-600">Third Party Verified</p>
          </div>
          <div>
            <div className="text-3xl font-bold text-orange-600 mb-2">Fast Shipping</div>
            <p className="text-gray-600">2-3 Business Days</p>
          </div>
          <div>
            <div className="text-3xl font-bold text-orange-600 mb-2">Expert Support</div>
